...
public class PastContinuousTense extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_past_continuous_tense);
    ...
    public class ExampleAdapter extends BaseAdapter {
        ...
        public View getView(final int i, View view, ViewGroup viewGroup) {
            View rowView = View.inflate(PastContinuousTense.this, R.layout.example_cell, null);
