...
public class FutureIndefinateTense extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_future_indefinate_tense);
    ...
    public class ExampleAdapter extends BaseAdapter {
        ...
        public View getView(final int i, View view, ViewGroup viewGroup) {
            View rowView = View.inflate(FutureIndefinateTense.this, R.layout.example_cell, null);
