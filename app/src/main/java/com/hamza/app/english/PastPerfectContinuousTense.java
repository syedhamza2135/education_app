...
public class PastPerfectContinuousTense extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_past_perfect_continuous_tense);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(getApplicationContext(), PastTense.class));
        finish();
    }
    ...
    public class ExampleAdapter extends BaseAdapter {
        ...
        public View getView(final int i, View view, ViewGroup viewGroup) {
            View rowView = View.inflate(PastPerfectContinuousTense.this, R.layout.example_cell, null);
