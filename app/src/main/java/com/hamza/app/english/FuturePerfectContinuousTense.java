...
public class FuturePerfectContinuousTense extends AppCompatActivity {
    ...
    public class ExampleAdapter extends BaseAdapter {
        ...
        public View getView(final int i, View view, ViewGroup viewGroup) {
            View rowView = View.inflate(FuturePerfectContinuousTense.this, R.layout.example_cell, null);
